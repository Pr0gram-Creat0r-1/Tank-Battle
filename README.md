...
Note: You MUST save the Tank_Battle folder directly to your local disk (C), so that the path to it becomes "C:\Tank_Battle". If you don't do this, your game will not work, because it will not be able to find the sound files/images.
